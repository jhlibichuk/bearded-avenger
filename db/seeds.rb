...
game2 = Game.create!(name:"Game 2: A Birthday Snappening", description: "Whether it's your first snap or your hundredth, let's celebrate!", start_date: DateTime.parse("2-6-2016").beginning_of_day, end_date: DateTime.parse("16-6-2016").end_of_day)
